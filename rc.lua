...
local space3                           = markup.font("Terminus 3", " ")
...
local widget_display_r                 = wibox.widget.imagebox(beautiful.widget_display_r)
local widget_display_l                 = wibox.widget.imagebox(beautiful.widget_display_l)
local widget_display_c                 = wibox.widget.imagebox(beautiful.widget_display_c)
...
local textclock                        = wibox.widget.textclock(markup(clockgf,
  space3 .. chosen_clock_type .. markup.font("Tamsyn 3", " ")))
...
-- Firefox_button
-- local firefox_button = awful.widget.button({ image = beautiful.firefox })
...
local home_fs_widget = wibox.container.background(home_fs.widget)
home_fs_widget.bgimage = beautiful.widget_display
...
-- Hotkeys
  ...
  awful.key({ altkey, "Shift" }, "=", function() lain.util.useless_gaps_resize(-default_gap_inc) end,
    { description = "increment useless gaps", group = "tag" }),
  awful.key({ altkey }, "-", function() lain.util.useless_gaps_resize(default_gap_inc) end,
    { description = "decrement useless gaps", group = "tag" }),
  awful.key({ altkey }, "=", function() lain.util.useless_gaps_resize(-1000) end,
    { description = "clear useless gaps", group = "tag" }),
